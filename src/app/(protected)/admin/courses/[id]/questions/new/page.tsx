...
export default function NewQuestionPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if (error) { toast.error('Failed to save question.', { description: error.message }); setLoading(false); return }
        ...
        <div className="space-y-6">
            <header className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Fill in the question and answer choices.</p>
                </div>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <div className="flex gap-3">
                    ...
                    <Button type="button" variant="outline" asChild>
                        <Link href={`/admin/courses/${id}`}>Cancel</Link>
                    </Button>
                </div>
            </form>
        </div>
